...
import "../../styles/components/UI/Project.css"
              ...
              <div className="inner-container">
                {/* <div className="project-block-wrapper"> */}
                    ...
                    <div className="project-buttons">
                        {
                            project_link &&
                            <Link to={project_link} target="_blank" className="project-link project__btn">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 51 26" className="project-link-button-icon">
                        ...
                        {
                            checkout_link &&
                            <Link to={checkout_link} target="_blank" className="project-checkout project__btn">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34" className="project-checkout-button-icon">
