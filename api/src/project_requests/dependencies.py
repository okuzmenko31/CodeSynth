...
project_req_create_data = Annotated[
    ProjectRequestCreateData, Depends(project_request_create_data)
]
project_req_update_data = Annotated[
    ProjectRequestUpdateData, Depends(project_request_update_data)
]
