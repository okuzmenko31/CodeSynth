...
const ProjectsWorkspace = () => {
    ...
    useEffect(() => {
        axios.get(getUrl + `?page=0&size=10`)
        .then(res => {
        ...
        <div className="workspace">
            ...
            }
            {
                ...
                <div className="add-item-modal">
                    ...
                    <div className="input-category">
                        <p className="small-text">Preview image</p>
                        <img className="admin-object-image" src={editObject.preview_image}/>
                        <input type="file" id="preview_image" className="admin-add-input" placeholder="Preview image" onChange={handleFileChange}/>
                    </div>
                    <button onClick={sendRequestForPatch} className="admin-button add">Send request</button>
                </div>
            }
                    ...
                    <ItemsListWorkspace 
                        ...
                        actions={(res: any) => {
                            ...
                            inputs.forEach((input: any) => {
                                const id = input.id
                                if (input && res.data[id] && input.type !== "file") {
